...
class BindingStore:
    ...
    def _init_schema(self) -> None:
        with self._connect() as conn:
            ...
            for col, decl in (
                ...
                ("telegram_username", "TEXT"),
                ("telegram_display_name", "TEXT"),
                ("bot_lang", "TEXT NOT NULL DEFAULT 'en'"),
                ("tutor_name", "TEXT"),
            ):
                if col not in cols:
        ...
        *,
        ...
        with self._connect() as conn:
            ...
            return Binding(
                ...
                bot_lang=(row["bot_lang"] if "bot_lang" in row.keys() else None) or "en",
    ...
    def _row_to_binding(row: sqlite3.Row | None) -> Binding | None:
        ...
        return Binding(
            ...
            bot_lang=(row["bot_lang"] if "bot_lang" in keys else None) or "en",
