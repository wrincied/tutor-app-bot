...
TEXTS: dict[Lang, dict[str, str]] = {
    "ru": {
        ...
        "notify_lesson_start_body": "Через {minutes} минут начинается урок{subject_part}{with_tutor} · {time}",
        ...
        "notify_lesson_moved_body": "Новое время{subject_part}{who}: {time}",
    ...
    "en": {
        ...
        "notify_lesson_start_body": "Lesson{subject_part}{with_tutor} starts in {minutes} min · {time}",
        ...
        "notify_lesson_moved_body": "New time{subject_part}{who}: {time}",
        "notify_lesson_moved_who": " ({name})",
    ...
    "de": {
        ...
        "notify_lesson_start_body": "In {minutes} Min. beginnt der Unterricht{subject_part}{with_tutor} · {time}",
        ...
        "notify_lesson_moved_body": "Neue Zeit{subject_part}{who}: {time}",
        "notify_lesson_moved_who": " ({name})",
