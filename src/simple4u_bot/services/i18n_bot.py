...
TEXTS: dict[Lang, dict[str, str]] = {
    "ru": {
        ...
        "lessons_empty": "За последние 30 дней занятий нет.",
        "lessons_title": "Последние занятия:",
        "lessons_screen_title": "Занятия",
        "lessons_page": "Стр. {page}/{pages}",
        "lessons_page_short": "{page}/{pages}",
        "btn_lessons_prev": "◀️",
        "btn_lessons_next": "▶️",
        ...
        "notify_balance_changed_title": "Баланс обновлён",
        "notify_balance_changed_delta": "{before} {unit} → {after} {unit}",
        "notify_balance_remaining": "Текущий баланс: {count} {unit}",
        ...
        "notify_balance_low_title": "Мало в абонементе",
        "notify_balance_low_lead": "Абонемент почти закончился.",
        "notify_balance_low_body": "Сейчас доступно {count} {unit}.",
        "notify_balance_empty_title": "Абонемент закончился",
        "notify_balance_empty_body": "Баланс равен нулю.",
        "notify_balance_empty_hint": "Пополни абонемент перед следующими занятиями.",
        ...
        "notify_payment_new_balance": "Новый баланс: {count} {unit}",
        "notify_lesson_start_title": "Скоро урок",
        "notify_lesson_start_body": "Через {minutes} мин. начинается занятие.",
        "notify_lesson_start_with_tutor": " с {name}",
        "notify_lesson_subject_part": " ({subject})",
        "notify_meeting_link": "Ссылка на звонок",
        "notify_homework_title": "Домашнее задание",
        "notify_homework_fallback": "Домашка: уточни у репетитора, если задание ещё не прислали.",
        "notify_lesson_moved_title": "Урок перенесён",
        "notify_lesson_moved_body": "Занятие теперь в {time}.",
    ...
    "en": {
        ...
        "lessons_empty": "No lessons in the last 30 days.",
        "lessons_title": "Recent lessons:",
        "lessons_screen_title": "Lessons",
        "lessons_page": "Page {page}/{pages}",
        "lessons_page_short": "{page}/{pages}",
        "btn_lessons_prev": "◀️",
        "btn_lessons_next": "▶️",
        ...
        "notify_balance_changed_delta": "{before} {unit} → {after} {unit}",
        "notify_balance_remaining": "Current balance: {count} {unit}",
        ...
        "notify_balance_low_lead": "Your package is running low.",
        "notify_balance_low_body": "Currently available: {count} {unit}.",
        "notify_balance_empty_title": "Package used up",
        "notify_balance_empty_body": "Your balance is zero.",
        "notify_balance_empty_hint": "Please top up before booking more lessons.",
        ...
        "notify_payment_new_balance": "New balance: {count} {unit}",
        "notify_lesson_start_title": "Lesson soon",
        "notify_lesson_start_body": "Lesson starts in {minutes} min.",
        "notify_lesson_start_with_tutor": " with {name}",
        "notify_lesson_subject_part": " ({subject})",
        "notify_meeting_link": "Call link",
        "notify_homework_title": "Homework",
        "notify_homework_fallback": "Homework: ask your tutor if the assignment was not sent yet.",
        "notify_lesson_moved_title": "Lesson rescheduled",
        "notify_lesson_moved_body": "Your lesson is now at {time}.",
        "notify_lesson_moved_who": " ({name})",
    ...
    "de": {
        ...
        "lessons_empty": "In den letzten 30 Tagen keine Stunden.",
        "lessons_title": "Letzte Stunden:",
        "lessons_screen_title": "Unterricht",
        "lessons_page": "Seite {page}/{pages}",
        "lessons_page_short": "{page}/{pages}",
        "btn_lessons_prev": "◀️",
        "btn_lessons_next": "▶️",
        ...
        "notify_balance_changed_title": "Guthaben aktualisiert",
        "notify_balance_changed_delta": "{before} {unit} → {after} {unit}",
        "notify_balance_remaining": "Aktuelles Guthaben: {count} {unit}",
        ...
        "notify_balance_low_lead": "Dein Guthaben ist fast aufgebraucht.",
        "notify_balance_low_body": "Aktuell sind noch {count} {unit} verfügbar.",
        "notify_balance_empty_title": "Abo aufgebraucht",
        "notify_balance_empty_body": "Dein Guthaben ist aufgebraucht.",
        "notify_balance_empty_hint": "Bitte lade dein Abo auf, bevor du weitere Stunden buchst.",
        ...
        "notify_payment_new_balance": "Neues Guthaben: {count} {unit}",
        "notify_lesson_start_title": "Bald Unterricht",
        "notify_lesson_start_body": "In {minutes} Min. beginnt der Unterricht.",
        "notify_lesson_start_with_tutor": " mit {name}",
        "notify_lesson_subject_part": " ({subject})",
        "notify_meeting_link": "Link zum Anruf",
        "notify_homework_title": "Hausaufgabe",
        "notify_homework_fallback": "Hausaufgabe: frag deinen Tutor, falls die Aufgabe noch fehlt.",
        "notify_lesson_moved_title": "Unterricht verschoben",
        "notify_lesson_moved_body": "Dein Unterricht findet jetzt um {time} statt.",
        "notify_lesson_moved_who": " ({name})",
